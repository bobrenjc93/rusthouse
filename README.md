...
case-insensitively. More than two nullable columns, nullable columns followed
by a non-nullable column, and other nullable types remain outside the bounded
grammar.
...
non-nullable prefix before the first nullable column (or a first nullable
column by itself), then emit ordered
