...
CSV string fields and names use RFC 4180 quoting, and nulls are written as `\N`. Input is limited to 128 MiB and 2,000,000 SQL tokens, a catalog to 128 tables, a table to 256 columns and 5,000,000 rows, `GROUP BY` to 64 expressions, materialized results and output to 256 MiB, each data type to 64 nesting levels, and each expression to 256 nesting levels and 1,024 AST nodes.
