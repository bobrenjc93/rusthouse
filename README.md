...
- COUNT, SUM, MIN, MAX, AVG, argMin, and argMax
...
On empty input, COUNT and SUM return numeric zero. MIN, MAX, AVG, argMin, and argMax return an actionable error because the current type system has no nullable result.
