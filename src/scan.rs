...
mod tests {
    ...
    #[test]
    fn intersects_packed_bytes_across_bitmap_boundaries() {
        ...
        let mut selection = table
            ...
            .unwrap();
        let upper = table
            .scan("id", ComparisonOperator::LessThanOrEqual, &Value::Int64(16))
            .unwrap();
        selection.intersect(&upper);

        assert_eq!(selection.as_bytes(), [0x80, 0xff, 0x01]);
        assert_eq!(
