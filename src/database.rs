...
use crate::{
    CreateTable, Field, MAX_IDENTIFIER_BYTES, MAX_SCHEMA_FIELDS, QueryResult, Schema, SqlError,
    SqlErrorKind, Statement, Table, parse_database_batch,
};
        ...
        for statement in statements {
            match statement {
                ...
                Statement::CreateTable(definition) => {
                    new_tables.push(build_table(input, definition)?);
                }
            }
        }
