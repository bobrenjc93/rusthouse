...
/// parameter, one decimal `max_group_key_bytes` parameter, one decimal
/// `max_ordering_state_bytes` parameter, one decimal `max_aggregate_state_cells`
/// parameter, one decimal
