...
pub use batch::{DatabaseMetrics, SharedDatabase, SharedDatabaseError, TableLimits};
pub use catalog::{
...
pub use snapshot::{
    ...
    Int64TablePayloadFileRestoreError, Int64TableRestoreError, NullableI64PayloadCodec,
    NullableI64PayloadError, NullableI64RlePayloadCodec, NullableI64RlePayloadError, SnapshotCodec,
    SnapshotError, SnapshotFileError, restore_int64_table, restore_int64_table_from_file,
