...
pub use execution::{
    InsertExecutionError, SelectExecutionError, execute_insert, execute_scalar_count,
...
pub use parser::{
    ...
    ScalarCountStatement, SelectStatement, parse_create_table, parse_insert, parse_scalar_count,
    parse_select,
};
pub use scan::{
