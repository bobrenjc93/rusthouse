...
pub enum Value {
    ...
    Bool(bool),
    String(String),
    /// A Gregorian date stored as signed days from 1970-01-01.
    Date(i32),
    /// A UTC timestamp stored as signed milliseconds from the Unix epoch.
    DateTime64(i64),
}
...
impl Value {
    ...
    pub fn as_display_string(&self) -> String {
        match self {
            ...
            Self::Date(value) => crate::temporal::format_date(*value),
            Self::DateTime64(value) => crate::temporal::format_datetime64(*value),
        }
    }
