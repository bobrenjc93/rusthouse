...
impl SharedDatabase {
    ...
    /// cap for supported parallel aggregates, including Bool-grouped row counts
    /// and `countIf`, nullable `Int64` or physical non-nullable column counts,
    /// and non-nullable Int64 `SUM`, `MIN`, `MAX`, or `AVG`.
    #[must_use]
