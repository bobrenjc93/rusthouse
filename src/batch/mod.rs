...
///
/// `CREATE TABLE`, `DROP TABLE`, and `INSERT` statements are silent. Each
/// `SELECT`, `SHOW TABLES`, or `DESCRIBE TABLE` result is rendered with the
...
///
/// `CREATE TABLE`, `DROP TABLE`, and `INSERT` statements are silent. `SELECT`,
/// `SHOW TABLES`, and `DESCRIBE TABLE` produce query results. All statements
...
///
/// `CREATE TABLE`, `DROP TABLE`, and `INSERT` statements are silent. Each
/// `SELECT`, `SHOW TABLES`, or `DESCRIBE TABLE` result is rendered on one line
/// with column metadata and positional rows.
