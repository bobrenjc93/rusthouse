...
The initial engine is single-process and single-node. Int64 columns already separate appendable tails from immutable, adaptively compressed chunks. Public interfaces should continue to leave room for parallel scans and a write-ahead log without prematurely distributing the engine.
