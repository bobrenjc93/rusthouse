...
1. A catalog owns schemas, tables, and parsed logical view definitions.
...
4. A query engine expands views and plans scans, filters, projections, grouping, aggregation, sorting, and limits.
