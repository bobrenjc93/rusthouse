...
6. Linux and macOS persistence resolves a stable destination, serializes deterministic versioned snapshots, replaces them atomically while verifying ACL and extended-attribute preservation, and rejects corrupt or incompatible data. Other platforms reject persistent opens until they have equivalent durable replacement and metadata protocols.
