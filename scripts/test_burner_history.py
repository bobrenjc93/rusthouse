...
class BurnerHistoryTests(unittest.TestCase):
    ...
    def test_seed_registers_all_six_complete_baseline_scores(self) -> None:
        ...
        self.assertEqual("86a8093e0d64e3c9aca7cbd52fa79afd8e063487", baseline["commit"])
    ...
    def test_score_sets_must_be_complete_and_in_range(self) -> None:
        ...
        missing["points"][0]["scores"].pop("eval_07088400")
        ...
        out_of_range["points"][0]["scores"]["eval_07088400"] = 101
        ...
        boolean["points"][0]["scores"]["eval_07088400"] = True
    ...
    def test_invalid_input_does_not_replace_generated_files(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            invalid["points"][0]["scores"].pop("eval_07088400")
